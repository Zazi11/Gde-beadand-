...
def main():
    ...
    szalloda.szoba_hozzaadasa(EgyagyasSzoba("12"))
    szalloda.szoba_hozzaadasa(KetagyasSzoba("2"))

    szalloda.foglalas("1", datetime.date(2024, 5, 10))
    szalloda.foglalas("12", datetime.date(2024, 7, 6))
    szalloda.foglalas("2", datetime.date(2024, 5, 9))
    szalloda.foglalas("1", datetime.date(2024, 5, 10))
    szalloda.foglalas("12", datetime.date(2024, 5, 11))
